...
Each patch is defined on a logical domain and map the mesh points to a physical domain (cf. Fig. \ref{log_phy_domain}). 
...
\paragraph{}
We focus on each part of the equations system solving to answer the questions raised in the introduction. We start be the advection equations. 
