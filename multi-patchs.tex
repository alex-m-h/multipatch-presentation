...
%		\draw[lightgray] (0,4) grid [step = 0.5] (2,6);
%		\draw[thick] (0,4) grid [step = 2] (2,6);
%		\draw[fill = red, color=red]  (2,4) circle (2pt);
%	\end{scope}
%		
%	\begin{scope}[shift={(0.25,0.5)}]
%		\draw[lightgray] (2,4) grid [step = 0.5] (4,6);
%		\draw[thick] (2,4) grid [step = 2] (4,6);
%		\draw[fill = red, color=red]  (2,4) circle (2pt);
%	\end{scope}
...
[Insert scheme of Alex with physical domain to explain better.]
